...
import { 
  ...
  BookOpen, Lightbulb, ChevronRight, Star, Clock
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-100 font-sans">
      <header className="bg-slate-900 text-white p-6 pb-12 rounded-b-[2.5rem] relative shadow-md">
        ...
        <div className="mt-10 text-center">
            <div className="inline-flex items-center gap-1 opacity-80 text-xs font-bold mb-3 bg-slate-800 px-3 py-1 rounded-full border border-slate-700">
                <MapPin className="w-3 h-3 text-green-400"/> 서울시 강남구 {townName}
            </div>
            
            <h1 className="text-3xl font-extrabold mb-4 leading-tight">
                {townName} <span className="text-green-400">푸른 약국</span>
            </h1>

            <div className="flex flex-col items-center gap-1.5 text-xs text-slate-400 mb-6">
                 <div className="flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 opacity-70"/> 
                    <span>월-금 09:00 ~ 19:00 / 토 09:00 ~ 14:00 (일요일 휴무)</span>
                 </div>
                 <div className="flex items-center gap-1.5">
                    <MapPin className="w-3.5 h-3.5 opacity-70"/> 
                    <span>서울시 강남구 {townName}로 123, 1층</span>
                 </div>
            </div>

            <p className="text-slate-300 text-sm font-medium border-t border-slate-800 pt-4 inline-block px-4">
      ...
      <main className="px-4 -mt-8 pb-12 space-y-6 relative z-10 max-w-md mx-auto">
        ...
        <section className="grid grid-cols-2 gap-3">
            <Link href="/health/qr-landing/benefits" className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 hover:border-green-500 transition-all text-left group">
             ...
             <Link href="/health/qr-landing/jobs" className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 hover:border-blue-500 transition-all text-left group">
             ...
             <Link href="/health/qr-landing/tips" className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 hover:border-yellow-500 transition-all text-left group">
             ...
             <Link href="/health/qr-landing/consulting" className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 hover:border-green-500 transition-all text-left group">
             ...
             <Link href="/health/qr-landing/columns" className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 hover:border-purple-500 transition-all text-left group">
             ...
             <Link href="/health/qr-landing/real-estate" className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 hover:border-slate-500 transition-all text-left group">
